(ns {{ns-name}}.models.bin.temp.model
  (:require
...
(def cursor-path [:bin :temp])

(defn app-state->cursor
  "Store data related to a given page in the bin that should be
  cleared when navigating to and from the page. Will default to
